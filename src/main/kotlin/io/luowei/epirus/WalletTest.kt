...
//        Bip32ECKeyPair.deriveKeyPair()
        val seed = MnemonicUtils.generateSeed("dutch stem expand friend evidence appear ride plate eternal calm fabric swear", null)
        val masterKeyPair = Bip32ECKeyPair.generateKeyPair(seed)
        for (i in 0..10)
            chidAddress(masterKeyPair, i)
        //0x9052549e68d4315b44dc16fe02b560ce87d7062f
//        0x1b5b507486620341dd178d9fd95a8c0887c1313b
//        0x1B5B507486620341dD178D9FD95a8C0887c1313b
    }

    private fun chidAddress(masterKeyPair: Bip32ECKeyPair, index: Int) {
        // m/44'/60'/0'/0/0
        val path = intArrayOf(44 or Bip32ECKeyPair.HARDENED_BIT, 60 or Bip32ECKeyPair.HARDENED_BIT, 0 or Bip32ECKeyPair.HARDENED_BIT, 0, index)
        ...
        println("m/44'/60'/0'/0/$index Address = ${credentials.address} Private Key = 0x${credentials.ecKeyPair.privateKey.toString(16)}")
    }
